...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_COLEMAKDHm] = LAYOUT(
		...
		ME_LGUI,	KC_Z,	KC_X,	KC_C,	KC_D,	KC_V,	_______,	_______,		_______,	_______,	KC_K,	KC_H,	KC_COMM,	KC_DOT,	KC_SLSH,	ME_RGUI,
								M_RDESC,	MO_QUAN,	FN_DEL,	NM_BSPC,	NV_TAB,		NV_ENT,	NM_SPC,	FN_ESC,	MO_QUAN,	KC_F16
		),
