...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_yubi (
		...
		LA_TAB,	KC_A,	KC_S,	KC_D,	KC_F,	KC_G,					KC_H,	KC_J,	KC_K,	KC_L,	KC_SCLN,	RA_QUOT,
	...
	[_NUMBER] = LAYOUT_yubi (
		...
		KC_UNDS,	KC_LBRC,	KC_LCBR,	KC_RCBR,	KC_RBRC,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	KC_QUES,	KC_PLUS,
						_______,			_______,	_______,	_______,	_______,	_______,	_______,			_______
	),
	...
	[_QUANTUM] = LAYOUT_yubi (
		...
		_______,	_______,	_______,	_______,	_______,	DB_TOGG,					_______,	NK_TOGG,	EE_CLR,	_______,	_______,	_______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_FUNCTION]	= { ENCODER_CCW_CW( _______,	_______ ),	ENCODER_CCW_CW( KC_VOLD,	KC_VOLU )  },
...
static void render_status(void) {
	...
	oled_write_P( ( keymap_config.nkro ) ? PSTR( "\n  NKRO" ) : PSTR( "\n      " ), false);
