...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = LAYOUT_yubi_v5a(
		...
		KC_GRV,	KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	LC_F8,	RC_F5,	KC_N,	KC_M,	KC_COMM,	KC_DOT,	KC_SLSH,	KC_PLUS,
		KC_LGUI,			M_RDESC,			LA_CAPWD,	NV_BSPC,	LS_DEL,	RS_ENT,	NM_SPC,	FN_F16,			KC_MPLY,			QT_MINS
	),
	...
	[_NUMBER] = LAYOUT_yubi_v5a(
		...
		KC_TILD,	_______,	KC_LCBR,	KC_RCBR,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	KC_EQL,
