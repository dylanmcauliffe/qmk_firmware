...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_planck_grid(
		...
		M_RDESC,	KC_LCTL,	KC_LGUI,	KC_LALT,	NM_BSPC,	NV_DEL,	NV_ENT,	NM_SPC,	FN_DEL,	MO_QUAN,	KC_RGUI,	KC_RCTL
	),
	...
	[_GAMEPAD] = LAYOUT_planck_grid (
		...
		KC_F16,	QT_O,	KC_LALT,	WP_ONE,	KC_SPC,	KC_LCTL,	_______,	NM_BSPC,	FN_DEL,	_______,	_______,	_______
	),
	...
	[_MEDIA] = LAYOUT_planck_grid(
		...
		_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,
		_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,
		KC_MPLY,	KC_MPRV,	KC_MNXT,	KC_MUTE,	KC_F16,	_______,	_______,	_______,	_______,	_______,	_______,	_______
	),
	
	[_FUNCTION] = LAYOUT_planck_grid(
		_______,	KC_F9,	KC_F10,	KC_F11,	KC_F12,	KC_PAUS,	KC_SLCK,	_______,	_______,	_______,	_______,	EEP_RST,
		KC_CAPS,	KC_F5,	KC_F6,	KC_F7,	KC_F8,	_______,	KC_NLCK,	_______,	_______,	_______,	_______,	_______,
	...
	[_QUANTUM] = LAYOUT_planck_grid (
		...
		TG_MEDI,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	RESET,	TG_MEDI
	),
};
